...
/*
 * cardtest3.c
 * This test is to test the card effect of Steward. It asserts the current player selected choice works properly: a. Draw 2 cards; b. Add 2 coins; c. Trash 2 cards.
 */
...
int main() {
    ...
    printf("\n >>>>> SUCCESS: Testing complete for Steward <<<<<\n\n");
